...
- [ ] タイトル・説明（プレーヤー下部）
- [ ] 難易度・視聴時間・タグの表示
- [ ] 「← 動画一覧に戻る」リンク（`next/link`）

### エラー・ローディング
- [ ] `app/videos/[id]/loading.tsx` を作成（スケルトン UI）
- [ ] `app/videos/[id]/error.tsx` を作成
